  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        //xử lý bung dnd_kit khi column là rỗng:
        // bên FE tạo card đặc biệt, không liên quan BE
        //card sẽ đc ẩn ở giao diện người dùng
        // cấu trúc Id của card này để Unique, k cần phản làm random
        // mỗi column chỉ đc có 1 FE_placeholderCard
        cardOrderIds: ['column-card-id-04-placeholder-card'],
        cards: [
          {
            _id: 'column-card-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-03',
